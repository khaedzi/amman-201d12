...
var sumth=sum(testArray[0],testArray[1])
var tosumth=sum(parseInt(sumth),testArray[2])
var thArray=[parseInt(tosumth)
,"2,3,4 was passed in as an array of numbers, and 9 is their sum."]
...
function multiplyArray(multArr) { //eslint-disable-line
        ...
        var multVariableA = multiply(multArr[0], multArr[1])[0];
        var multVariableB = multiply (multVariableA, multArr[2])[0]; 
        var arrayQuwstion5 = [
            multVariableB, 
            "The numbers 2,3,4 have a product of 24.", 
        ]
        return arrayQuwstion5
        ; 
}
